/**
 * Global JavaScript for RawLifeMD Theme
...
class VariantSelects extends HTMLElement {
  ...
  updateVariantStatuses() {
    const addButtonText = document.querySelector(`#product-form-${this.dataset.section} .product-form__buttons button span`);
  ...
  renderProductInfo() {
    ...
    fetch(`${this.dataset.url}?variant=${requestedVariantId}&section_id=${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}`)
      ...
      .then((responseText) => {
        ...
        const qtyRules = html.getElementById(`Quantity-Rules-${sectionId}`);
        const volumeNote = html.getElementById(`Volume-Note-${sectionId}`);
  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      connectedCallback() {
        ...
        subscribe(PUB_SUB_EVENTS.variantChange, onVariantChange.bind(this));
      }

      updateVariantStatuses() {
        const addButtons = document.querySelectorAll(`#product-form-${this.dataset.section} [name="add"]`);
        const texts = document.querySelectorAll(`#product-form-${this.dataset.section} [name="add"] .loading-overlay__spinner`);

        texts.forEach((text) => text.classList.add('hidden'));
        addButtons.forEach((button) => button.classList.remove('loading'));
      }
    }
  );
}
